...
##
atmos <- read.csv(paste0(dirComp[compID],"/forest_soil/climate/weather_campus/v2.1/Atmos41_weather.csv"))


# coop snow and precip data from westmoreland
  snow <- read.csv(paste0(dirComp[compID],"/forest_soil/climate/snow_westermoreland/5_1_26/4309154.csv"))
# units in mm
...
romeWeather <- read.csv(paste0(dirComp[compID],"/forest_soil/climate/Rome/5_8_26/4309158.csv"))
rome <- romeWeather %>%
